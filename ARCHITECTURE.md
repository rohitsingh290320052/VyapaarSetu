...
1. Build onboarding flows and profile models for retailers and brands
2. Implement MOQ group buy lifecycle, pricing tiers, and participation tracking
3. Create admin dashboard APIs and UI pages
4. Add payment integration with Razorpay
5. Enable WebSocket powered real-time order progress and notifications
6. Add analytics, referral, and fintech scoring modules
